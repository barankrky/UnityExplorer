...
public static class SceneHandler
{
    ...
    public static bool InspectingAssetScene => SelectedScene.HasValue && SelectedScene.Value.GetSceneIntHandle() == -1;
    ...
    internal static void Init()
    {
        ...
        try
        {
            string? sceneName = UnityHelpers.GetSceneNameByIntHandle(-12);
...
#pragma warning restore CS0618 // 型またはメンバーが旧型式です
            ...
            catch (Exception fallbackEx)
            {
                ...
                ExplorerCore.LogWarning($"Fallback check via SceneManager.GetAllScenes() also failed: {fallbackEx}");
            }
        }
    ...
    internal static void Update()
    {
        ...
        bool inspectedExists =
            ...
            && ((DontDestroyExists && SelectedScene.Value.GetSceneIntHandle() == -12)
                || SelectedScene.Value.GetSceneIntHandle() == -1);
        ...
        {
            LoadedScenes.Add(UnityHelpers.CreateSceneFromIntHandle(-12));
        }
        LoadedScenes.Add(UnityHelpers.CreateSceneFromIntHandle(-1));
